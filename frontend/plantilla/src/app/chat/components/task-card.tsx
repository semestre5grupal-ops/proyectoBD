 ...
 *
 * Props:
 *   tarea             — TareaInventario generada por use-agent.ts
...
import type { TareaInventario, AccionInventario } from "@/app/chat/types/erp-agent"
...
const ACCION_CONFIG: Record<AccionInventario, AccionConfig> = {
  INGRESAR_STOCK: {
