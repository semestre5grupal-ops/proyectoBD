        ...
        <div className="grid gap-8 grid-cols-4 lg:grid-cols-6">
          ...
          <div className="col-span-4 lg:col-span-2 max-w-2xl">
            <div className="flex items-center space-x-2 mb-4 max-lg:justify-center">
              <a href="https://ERP Comercial.com" target='_blank' className="flex items-center space-x-2 cursor-pointer">
                <Logo size={32} />
                <span className="font-bold text-xl">ERP Comercial</span>
              </a>
            </div>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-2">
          <div className="flex flex-col sm:flex-row items-center gap-2 text-muted-foreground text-sm">
            <div className="flex items-center gap-1">
              ...
              <span>by</span>
              <a href="https://ERP Comercial.com" target='_blank' className="font-semibold text-foreground hover:text-primary transition-colors cursor-pointer">
                ERP Comercial
              </a>
            </div>
