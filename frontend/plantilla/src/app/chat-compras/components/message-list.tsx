...
import { type Message, type User } from "@/app/chat-compras/use-chat"
import { TaskCard } from "@/app/chat-compras/components/task-card"
import type { MensajeERP } from "@/app/chat-compras/types/erp-agent"

interface MessageListProps {
  messages: Message[]
  users: User[]
  currentUserId?: string
  /** Callback para confirmar una TareaCompras pendiente */
  onConfirmarTarea?: (tareaId: string) => Promise<void>
  /** Callback para rechazar una TareaCompras pendiente */
